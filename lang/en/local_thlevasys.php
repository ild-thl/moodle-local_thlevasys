...
$string['export_evalresponserate'] = 'Response rate reminder';
...
$string['export_table_csv'] = 'CSV for Excel';
...
$string['error_export_daterequired'] = 'Please enter evaluation start, reminder, response rate reminder and end dates.';
$string['error_export_reminderbeforestart'] = 'The evaluation reminder must be after the evaluation start.';
$string['error_export_responseratebeforereminder'] = 'The response rate reminder must be after the evaluation reminder.';
$string['error_export_endbeforeresponserate'] = 'The evaluation end must be after the response rate reminder.';
